...
export const agaData: SpecialistType = {
  ...
  biography: {
    ...
    imageSrc: "/aga/bio.jpg",
  },
  contact: {
    phone: "+48 519 559 509",
    famousDoctorHref:
      "https://www.znanylekarz.pl/agnieszka-olchawa-2/radioterapeuta-lekarze-wykonujacy-zabiegi-medycyny-estetycznej/nowy-sacz",
    facebookHref:
      "https://www.facebook.com/Lek.med.AgnieszkaOlchawa/?locale=pl_PL",
  },
  statistics: [
    {
      id: 1,
