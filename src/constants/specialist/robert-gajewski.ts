...
export const robertData: SpecialistType = {
  profile: {
    ...
    imageSrc: `${import.meta.env.VITE_ASSET_PREFIX}/robert/robert-gajewski.png`,
  },
  biography: {
    ...
    imageSrc: `${import.meta.env.VITE_ASSET_PREFIX}/robert/gabinet-4.webp`,
  },
  contact: {
    address: {
  ...
  timeline: {
    image: `${import.meta.env.VITE_ASSET_PREFIX}/robert/gabinet-2.webp`,
    item: [
      {
