            ...
            <div className="grid lg:grid-cols-2 gap-8">
              <VerticalScroll className="flex flex-col gap-3 sm:gap-5 xl:gap-8">
                ...
                <p className="text-muted-foreground text-sm sm:text-base xl:text-lg">
                  ...
                  25-letnim doświadczeniem. Oferuję kompleksową diagnostykę oraz
                  leczenie schorzeń piersi, przewodu pokarmowego, chorób skóry
                  oraz nowotworów tych narządów, żylaków kończyn dolnych oraz
                  żylaków odbytu. Wykonuję również zaawansowane zabiegi
                  chirurgii estetycznej i plastycznej, takie jak korekta powiek,
                  korekta odstających uszu, plastyka powłok brzucha, liposukcja
                  czy leczenie ginekomastii. Profesjonalizm, precyzja i
                  indywidualne podejście gwarantują pacjentom najwyższy standard
                  opieki z mojej strony.
                </p>
              </VerticalScroll>
        ...
        <VerticalScroll className="w-full p-8 md:p-12 lg:p-16 bg-accent rounded-4xl">
          <VerticalScroll className="grid gap-6">
            ...
            <p className="mt-6 lg:mt-14 text-balance text-center text-muted-foreground text-[12px] sm:text-sm">
              Pamiętaj, że nasz cennik nie obejmuje zabiegów wykonywanych przez
              tych specjalistów. Aby uzyskać szczegółowe informacje, skontaktuj
